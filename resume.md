...
### 公司救援平台微信车主端前端（2018年3月 ~ 2018年5月）
- 与中国人保合作，通过中国人保救援公众号作为入口，提供给车主用户使用，以发起救援请求、查看救援进度、查看救援车辆实时位置、接受救援推送等。
- 使用VueJS，基于`VUX`的组件库，前后端分离，多页面的webpack配置
- 印象深刻的点：VUX的使用，救援状态的逻辑处理，救援状态数据的实时获取，图片懒加载，组件的抽取与复用。
- 负责了整个项目的前端模块（7个页面左右）

### 公司救援平台微信司机端前端（2017年12月 ~ 2018年2月）
- 以公众号作为入口的移动端项目，提供救援车辆的司机使用，主要包括司机选择车辆、司机接单、司机救援、上传救援现场图片、到现场的路线导航等功能。
- 使用VueJS，基于`VUX`的组件库，前后端分离，多页面的webpack配置
